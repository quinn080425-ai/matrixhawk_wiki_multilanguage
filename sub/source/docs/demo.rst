...
.. [4] Here's a referenced footnote, with a reference to a
   footnote: [5]_.
...
Here's a reference to the above, [Citation]_. Reference to [4]_.
...
Here's a hyperlink reference without a target, which would generate an error if it were a link.
